    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <h3>Users Results</h3>
					...
					$sql1 = mysqli_query($con,"SELECT DISTINCT name FROM answer")
					or die(mysqli_error()); 
					while($row1 = mysqli_fetch_array($sql1)){
					
					$sql2 = mysqli_query($con,"SELECT id,name,tel,SUM(marks) AS mak FROM answer WHERE name='".$row1["name"]."'")
					or die(mysqli_error()); 
					...
					<td><?php echo number_format($row2["mak"]);?></td>
					</tr>
					<?php
					}
					}
