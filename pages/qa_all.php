    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <h3>All Questionnaires</h3>
					...
					$con=mysqli_connect('localhost','root','','xyz') or die(mysqli_error());
						$sql1=mysqli_query($con,"SELECT DISTINCT category FROM questions")
					or die(mysqli_error());
					...
					<tr>
					<td><h4><?php echo $row1["category"];?></h4></td>
					<tr>
					<?php
					
					$con=mysqli_connect('localhost','root','','xyz') or die(mysqli_error());
						$sql2=mysqli_query($con,"SELECT DISTINCT SubjectArea FROM questions WHERE category='$row1[category]'")
					or die(mysqli_error());
					...
					<td><?php echo $row2["SubjectArea"];?></td>
					<td><a target="blank" href="qa_sheet.php?id=1&cat=<?php echo $row1["category"];?>"/>View Questions<a></td>
					</tr>
					<?php
