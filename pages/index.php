    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                                  ...
                                  <?php
					$con=mysqli_connect('localhost','root','','xyz') or die(mysqli_error());
					$sql1=mysqli_query($con,"SELECT DISTINCT sname AS sss FROM result_tbl")
					or die(mysqli_error()); 
					while($row1 = mysqli_fetch_array($sql1)){
					
					$sql = mysqli_query($con,"SELECT COUNT(id) AS iid,sname FROM result_tbl WHERE sname='".$row1["sss"]."'")
					or die(mysqli_error()); 
				...
				<div class="huge"><?php echo $row["iid"] ?></div>
